...
The following are the minimal [recommended requirements](https://hub.docker.com/_/logstash):
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r logstash
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r logstash -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-logstash
cd docker-logstash
...
You can point your browser to: *`http://Instance's Internet IP:5432`*  
...
[Logstash Administrator Guide](https://support.websoft9.com/docs/logstash)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Logstash Enterprise Support](https://apps.websoft9.com/logstash) 
